...
class TerminalUI:
    ...
    def run(self):
        ...
        '''
        self.display_menu()
        self._tree = self._tree.add(5)
        self._tree = self._tree.add(3)
        self._tree = self._tree.add(1)
        self._tree = self._tree.add(8)
        self._tree = self._tree.add(7)
        self._tree = self._tree.add(6)
        self._tree = self._tree.add(9)
        self._tree = self._tree.add(15)
        self._tree = self._tree.add(14)
        self._tree = self._tree.add(16)
        self._tree = self._tree.add(2)
        self._tree = self._tree.add(11)
        self._tree = self._tree.add(4)
        self._tree = self._tree.add(18)
